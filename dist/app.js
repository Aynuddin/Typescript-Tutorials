...
let bigNum = BigInt(9087654321234567878987654);
console.log(bigNum);
// Symbol data type
...
let user = ["Ayn", "Uddin", "Khan"];
console.log(user);
let prices = [30, 80, 60, 59];
console.log(prices);
let statusVal = [true, false, true];
console.log(statusVal);
// Arrays method operations
let nums = [12, 34, 54, 27];
...
let price = [100, 200, 600];
let total = price.reduce((sum, pri) => sum + pri, 0);
console.log(total);
// Tuples in TS
let obj = ["Ayn", 28];
console.log(obj);
let obj1 = ["Ayn", 25, true];
console.log(obj1);
// Destructing this 
